...
def etl_inicial_green_house_emissions(request):
    ...
    blobs = list(bucket.list_blobs(prefix='raw_datasets/green_house_emissions/_', max_results=3))    
    ...
    for blob in blobs: 
        ...
        print(f'Registros en tabla green_house_emissions antes de la carga: {format_count(rows_before_load)}')
        ...
        print(f'Registros en tabla green_house_emissions después de la carga: {format_count(rows_after_load)}')
